...
import type { PaginatedPharmacyReportListItems } from "../types/admin.types";
...
export function listOwnReports(page = 1, limit = 20) {
  ...
  return apiRequest<PaginatedPharmacyReportListItems>(`/pharmacies/me/reports?${query.toString()}`);
}
